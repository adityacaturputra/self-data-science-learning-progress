...
# a variable called rand_vars_7 contains 5000 random draws from the Poisson distribution with lambda = 7.
# 5000 draws, lambda = 7
...
# a variable called rand_vars_17 contains 5000 random draws from the Poisson distribution with lambda = 17.
